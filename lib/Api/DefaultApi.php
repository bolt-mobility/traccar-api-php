...
class DefaultApi
{
    ...
    protected function reportsDisputeGetRequest($from, $to, $device_id = null, $user_id = null, $group_id = null)
    {
        ...
        if (is_array($device_id)) {
            $queryParams['deviceId'] = $device_id;
        } else
        if ($device_id !== null) {
            $queryParams['deviceId'] = ObjectSerializer::toQueryValue($device_id);
        }
     ...
     * @return \Swagger\Client\Model\User
     */
    public function sessionRegisterGet($token = null, $geo_id = null, $app_version = null)
    {
        list($response) = $this->sessionRegisterGetWithHttpInfo($token, $geo_id, $app_version);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\User, HTTP status code, HTTP response headers (array of strings)
     */
    public function sessionRegisterGetWithHttpInfo($token = null, $geo_id = null, $app_version = null)
    {
        $returnType = '\Swagger\Client\Model\User';
        $request = $this->sessionRegisterGetRequest($token, $geo_id, $app_version);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sessionRegisterGetAsync($token = null, $geo_id = null, $app_version = null)
    {
        return $this->sessionRegisterGetAsyncWithHttpInfo($token, $geo_id, $app_version)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sessionRegisterGetAsyncWithHttpInfo($token = null, $geo_id = null, $app_version = null)
    {
        $returnType = '\Swagger\Client\Model\User';
        $request = $this->sessionRegisterGetRequest($token, $geo_id, $app_version);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sessionRegisterGetRequest($token = null, $geo_id = null, $app_version = null)
    {
